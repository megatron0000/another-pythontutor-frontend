...
import * as noRegexpRule from "./lib/no-regexp";
import * as noTryCatchRule from "./lib/no-try-catch";
import * as noWithRule from "./lib/no-with";
import * as noGetterSetterRule from "./lib/no-getter-setter";
import * as noThrowRule from "./lib/no-throw";
