// https://raw.githubusercontent.com/ajaxorg/ace-builds/master/ace.d.ts
...
export namespace Ace {
  ...
  interface Folding {
    ...
    unfold(
      location: null | number | Point | Range,
      expandInner?: boolean
    ): Fold[] | undefined;
  ...
  export interface EditSession extends EventEmitter, OptionsProvider, Folding {
    ...
    on(
      name: "changeFold",
      callback: (obj: { data: Fold; action: string }) => void
    ): Function;
    on(
  ...
  export interface Editor extends OptionsProvider, EventEmitter {
    ...
    setOption<T extends keyof EditorOptions>(
      name: T,
      value: EditorOptions[T]
    ): void;
