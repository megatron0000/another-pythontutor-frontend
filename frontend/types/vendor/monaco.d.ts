// adapted from:
// https://raw.githubusercontent.com/microsoft/monaco-editor/main/website/typedoc/monaco.d.ts
// I changed "declare namespace" to "export namespace" to fit my requirejs scenario
...
export let MonacoEnvironment: monaco.Environment | undefined;
...
export namespace monaco.languages.css {
...
export namespace monaco.languages.html {
...
export namespace monaco.languages.json {
...
export namespace monaco.languages.typescript {
